		...
		<div class="wrapper-page">
			<div class=" card-box">
				<div class="panel-heading">
					<h3 class="text-center">注册到<strong class="text-custom">系统</strong> </h3>
				</div>
						...
						<div class="form-group">
							<div class="col-xs-12">
								<div class="checkbox checkbox-primary">
									...
									<label for="checkbox-signup">我同意 <a href="#">用户许可协议</a></label>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>
						已经有了一个账户?<a href="/login" class="text-primary m-l-5"><b>登录</b></a>
					</p>
				</div>
			</div>
